    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        @if (Route::has('register'))
            <p class="mt-2 text-sm text-center text-gray-600 leading-5 max-w">
                Or
                <a href="{{ route('register') }}" class="font-medium text-blue hover:text-blue/90 focus:outline-none focus:underline transition ease-in-out duration-150">
            ...
            <form wire:submit.prevent="authenticate">
                ...
                <div class="mt-6">
                    <span class="block w-full rounded-md shadow-sm">
                        <button type="submit" class="flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-green border border-transparent rounded-md hover:bg-green/90 focus:outline-none focus:green/90 focus:ring-green active:bg-green/90 transition duration-150 ease-in-out">
                            Sign in
                        </button>
                    </span>
                </div>
